<header>
    ...
    <div class="flex justify-between items-center px-6 sm:px-12 lg:px-20 2xl:px-28 py-7 border-b border-b-primary-400">
        ...
        <div class="flex lg:justify-center items-center gap-20">
            ...
            {{-- nav --}}
            <nav id="menu"
                class="fixed lg:static top-[121px] left-0 right-0 bottom-0  flex justify-center items-center bg-secondary-400 lg:bg-transparent translate-x-[100%] lg:translate-x-0 duration-500  ease-in-out z-50">
