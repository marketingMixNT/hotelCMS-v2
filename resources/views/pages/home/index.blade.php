<x-layouts.app>
    ...
    <x-slot name='header'>
        <div class="grid lg:grid-cols-2 ">
            ...
            {{-- img --}}
            <div class="relative h-[500px] lg:h-[80vh] 2xl:h-[85vh]"><img src="{{ asset('assets/img/hero.jpg') }}"
                    alt="widok na jeden z apartamentów w Sunny Shoreline" class="h-full w-full object-cover" width="884" height="901">
                
                <div class="absolute right-5 bottom-5 flex gap-6">
